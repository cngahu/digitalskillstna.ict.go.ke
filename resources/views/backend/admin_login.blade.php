                                    ...
                                    <form class="row g-3" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input text-green-600"  type="checkbox" id="flexSwitchCheckChecked" style="color:darkgreen" checked>
                                                <label class="form-check-label" for="flexSwitchCheckChecked" style="color: darkgreen">Remember Me</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6 text-green-600"> <a href="authentication-forgot-password.html">Forgot Password ?</a>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-grid">
